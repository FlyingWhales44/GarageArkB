...
namespace ArkBarGarage.Controllers
{
    public class OwnerModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Surname,PhoneNumber,Email")] OwnerModels ownerModels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Surname,PhoneNumber,Email")] OwnerModels ownerModels)
        {
            if (ModelState.IsValid)
            {
